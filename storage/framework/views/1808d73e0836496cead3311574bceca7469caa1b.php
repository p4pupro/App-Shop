                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre" name="name"
                                       value="<?php echo e(old('name', $name)); ?>" required autofocus>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon">
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" type="email" placeholder="Correo electrónico" class="form-control" name="email" value="<?php echo e(old('email', $email)); ?>">
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="phone" type="phone" placeholder="Teléfono" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>" required>
                            </div>                            
                            ...
                            <div class="input-group">
                                ...
                                <input id="address" type="text" placeholder="Dirección" class="form-control" name="address" value="<?php echo e(old('address')); ?>" required>
                            </div>  
